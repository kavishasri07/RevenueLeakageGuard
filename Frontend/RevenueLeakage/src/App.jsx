    ...
    <div className="page-content">
      ...
      <div className="page-intro">
        ...
        <div>
          ...
          <p>
            Monitor revenue leakage across
      ...
      <div className="kpi-grid">
        ...
        <KPICard
          ...
          value={
            dashboardData?.potentialRevenueLeakage
          }
        ...
        <KPICard
          ...
          value={
            dashboardData?.approvedRecovery
          }
        ...
        <KPICard
          ...
          value={
            dashboardData?.customersMonitored
          }
      ...
      <div className="panel customer-panel">
        ...
        <EmptyTable
          ...
          action="Customer records will appear after the backend is connected."
        />
...
function CustomersPage({ setPage }) {
  /*
    ...
    Replace with API call such as:

    GET /api/customers

    Then store result in state:
    ...
    <div className="page-content">
      ...
      <div className="page-intro">
        ...
        <div>
          ...
          <p>
            Review contract, usage and billing
            alignment across every account.
          </p>
        </div>
      ...
      <div className="panel">
        ...
        <div className="panel-header">
          ...
          <div>
            ...
            <p>
              Customer data from your backend
            </p>
          </div>
        ...
        {customers.length === 0 ? (
          <EmptyTable
            ...
            action="Connect the customers API to populate this table."
          />
        ) : (
    ...
    <div className="page-content">
      ...
      <div className="page-intro">
        ...
        <div>
          ...
          <p>
            Review detected revenue leakage
            before customer-facing adjustments
            are made.
          </p>
        </div>
      ...
      {findings.length === 0 ? (
        <div className="panel">
          ...
          <EmptyTable
            ...
            action="Finding records will appear here once the backend is connected."
          />
                ...
                >
                  ...
                  <div className="finding-top">
                    ...
                    <div>
                      ...
                      <div className="finding-customer">
                        {finding.customer}
                      </div>
    ...
    <div className="page-content">
      ...
      <div className="recovery-kpis">
        ...
        <KPICard
          ...
          value={
            recoveryData?.potentialRecovery
          }
          helper="Total detected opportunity"
          icon="dollar"
          variant="blue"
        />
        ...
        <KPICard
          label="Approved Recovery"
          value={
            recoveryData?.approvedRecovery
          }
          helper="Finance-approved opportunity"
          icon="check"
          variant="green"
        />
        ...
        <KPICard
          ...
          value={
            recoveryData?.recoveredRevenue
          }
          helper="Actual collected revenue"
          icon="recovery"
          variant="purple"
        />
      ...
      <div className="panel">
        ...
        {!recoveryData ||
        !recoveryData.opportunities?.length ? (
          <EmptyTable
            message="No approved opportunities yet."
            action="Approved recovery opportunities will appear here after the backend is connected."
          />
        ) : (
          <div className="table-wrapper">
            ...
            <table>
              ...
              <tbody>
                ...
                {recoveryData.opportunities.map(
                  (opportunity) => (
                    <tr
                      key={
                        opportunity.id
